...
var IETF_TAGS_TO_CONTAINER_ROLE_LABEL = Object.freeze((_Object$freeze2 = {}, _defineProperty(_Object$freeze2, ENGLISH_IETF_TAG, 'Notice about use of cookies on diceytech.co.uk.'), _defineProperty(_Object$freeze2, SPANISH_IETF_TAG, 'Aviso sobre el uso de cookies en diceytech.co.uk.'), _Object$freeze2));
var IETF_TAGS_TO_CLOSE_BUTTON_LABEL = Object.freeze((_Object$freeze3 = {}, _defineProperty(_Object$freeze3, ENGLISH_IETF_TAG, 'Close the notice about use of cookies on diceytech.co.uk.'), _defineProperty(_Object$freeze3, SPANISH_IETF_TAG, 'Cerrar aviso sobre el uso de cookies en diceytech.co.uk.'), _Object$freeze3));
...
var getPolicyHTML = function getPolicyHTML(tag) {
  ...
  if (tag === SPANISH_IETF_TAG) {
    var _linkOpen = '<a href="https://diceytech.co.uk/privacy-policy/" class="policy-link" target = "_blank">';
  ...
  var linkOpen = '<a href="https://diceytech.co.uk/privacy-policy/" class="policy-link" target = "_blank">';
  return "Dicey Tech uses cookies and other tracking technologies for performance, analytics, and marketing purposes. By using this website, you accept this use. Learn more about these technologies in the ".concat(linkOpen, "Privacy Policy").concat(linkClose, ".");
};
